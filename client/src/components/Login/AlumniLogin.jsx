// src/components/Login/AlumniLogin.jsx
...
const AlumniLogin = () => {
  ...
  return (
    <form onSubmit={handleSubmit} className="max-w-sm mx-auto p-6 bg-white rounded-lg">
      <h1 className="text-2xl font-bold mb-6 text-center">Alumni Login</h1>
      <div className="mb-4">
        <label htmlFor="alumniEmail" className="block text-sm font-medium text-gray-700 mb-1">Email</label>
        <input
          type="email"
          id="alumniEmail"
          value={email}
      ...
      <div className="mb-6">
        <label htmlFor="alumniPassword" className="block text-sm font-medium text-gray-700 mb-1">Password</label>
        <input
          type="password"
          id="alumniPassword"
          value={password}
